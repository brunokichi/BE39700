...
const MONGO_DB_NAME_TEST = process.env.MONGO_DB_NAME_TEST;
...
export const config = {
    db:{
        ...
        mongoUrlTest:`mongodb+srv://${MONGO_DB_USER}:${MONGO_DB_PASS}@coder.0pay6zu.mongodb.net/${MONGO_DB_NAME_TEST}?retryWrites=true&w=majority`,
    },
    server:{
        port:PORT,
    },
